StartupEvents.registry("block", (event) => {
  event.create("micro_universe_energy_transmitter").displayName("Micro Universe Energy Transmitter")
  event.create("micro_universe_focus_lens").displayName("Micro Universe Focus Lens")
})

GTCEuStartupEvents.registry("gtceu:recipe_type", (event) => {
  event
    .create("micro_universe_reactor")
    .category("gregstar")
    .setEUIO("out")
  ...
  event
    .create("micro_universe_collector")
    .category("gregstar")
    .setEUIO("in")
...
GTCEuStartupEvents.registry("gtceu:machine", (event) => {
  event
    .create("micro_universe_orb", "multiblock")
    ...
    .pattern((definition) =>
      FactoryBlockPattern.start()
        ...
        .aisle(
          ...
          "C  GGG                  D###D                  GGG  C",
          "I GGGGG                D#####D                GGGGG I",
          "FGGGGGGG              W#######W              GGGGGGGF",
          "FGGGSGGG              W#######W              GGGSGGGF",
          "FGGGGGGG              W#######W              GGGGGGGF",
          "I GGGGG                D#####D                GGGGG I",
          "C  GGG                  D###D                  GGG  C",
          " CCC                     DDD                     CCC ",
        ...
        .where(
          "T",
          Predicates.blocks(GTBlocks.SUPERCONDUCTING_COIL.get())
            .setMinGlobalLimited(600)
            .or(
              Predicates.abilities(
                PartAbility.EXPORT_ITEMS,
                PartAbility.EXPORT_FLUIDS,
                PartAbility.OUTPUT_LASER /*change to OUTPUT_LASER after that's released*/
              )
            )
        )
        ...
        .where(
          ...
          Predicates.abilities(
            ...
            PartAbility.INPUT_LASER /*change to INPUT_LASER after that's released*/
          ).or(Predicates.blocks("gtceu:atomic_casing"))
        )
        .where(
          "F",
          Predicates["autoAbilities(boolean,boolean,boolean)"](true, false, true).or(
